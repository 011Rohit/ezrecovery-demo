...
export default function MonthlyMain() {
    ...
    return (
        <center>
            <h4>Monthly Report for {moment().format('MMMM, YYYY')}</h4>
                    ...
                    <TableBody>
                        {fieldAlloc.map((detail) => (
                            <StyledTableRow key={detail.id}>
                                ...
                                <StyledTableCell align="right">{detail.visited}</StyledTableCell>
                                <StyledTableCell align="right">{detail.successfulVisit}</StyledTableCell>
                                <StyledTableCell align="right">{detail.remainingVisit}</StyledTableCell>
...
//                     title={`Monthly Report for ${moment().format('MMMM, YYYY')}`}
//                 />
//             }
//             {dataNull &&
